package com.witcha.customerchatbot.service.impl;

import com.witcha.customerchatbot.service.ChatService;
import com.witcha.customerchatbot.service.PromptManagementService;
    ...
    public Mono<Map<String, Object>> chat(String chatId, String message) {
        ...
        return chatClient.stream(prompt)
                ...
                .map(contentList -> {
                    ...
                    outputMap.put("output", finalGeneration.getOutput());
                    outputMap.put("metadata", generationMetadata); // Include metadata
